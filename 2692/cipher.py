...
class URANUS:
    ...
    def _shift_columns(self):
        self._state = [
            self._state[ 0], self._state[13], self._state[10], self._state[ 7],
            self._state[ 4], self._state[ 1], self._state[14], self._state[11],
            self._state[ 8], self._state[ 5], self._state[ 2], self._state[15],
            self._state[12], self._state[ 9], self._state[ 6], self._state[ 3]
        ]
    ...
    def _encrypt(self, plaintext):
        ...
        for round_n in range(1, self._round+1):
            if round_n % 2 == 0:
                self._sub_bytes()
                self._shift_columns()
                self._mix_columns()
