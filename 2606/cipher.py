class Cipher():
    def __init__(self, key: list, nonce: int):
        self.s1 =  (0x70, 0x82, 0x2c, 0xec, 0xb3, 0x27, 0xc0, 0xe5, 0xe4, 0x85, 0x57, 0x35, 0xea, 0x0c, 0xae, 0x41,
        ...
        self.s2 =  (0xe0, 0x05, 0x58, 0xd9, 0x67, 0x4e, 0x81, 0xcb, 0xc9, 0x0b, 0xae, 0x6a, 0xd5, 0x18, 0x5d, 0x82,
        ...
        self.s3 =  (0x38, 0x41, 0x16, 0x76, 0xd9, 0x93, 0x60, 0xf2, 0x72, 0xc2, 0xab, 0x9a, 0x75, 0x06, 0x57, 0xa0,
        ...
        self.s4 =  (0x70, 0x2c, 0xb3, 0xc0, 0xe4, 0x57, 0xea, 0xae, 0x23, 0x6b, 0x45, 0xa5, 0xed, 0x4f, 0x1d, 0x92,
        ...
        self.r =   ()

        self.k = key
        self.K = [0 for _ in range(256)]
        self.S1 = [0 for _ in range(256)]
        self.S2 = [0 for _ in range(256)]
        self.S3 = [0 for _ in range(256)]
        self.S4 = [0 for _ in range(256)]
        ...
        self.K = tuple(self.K)
        self.S1 = tuple(self.S1)
        self.S2 = tuple(self.S2)
        self.S3 = tuple(self.S3)
        self.S4 = tuple(self.S4)
    ...
    def encrypt(self, plaintext: bytes):
        ciphertext = b""
        for i in plaintext:
            a, b, c, d = self.ctr & 0xFF, (self.ctr >> 8) & 0xFF, (self.ctr >> 16) & 0xFF, (self.ctr >> 24) & 0xFF
            i = self.k[i]
            i = self.s1[(i + a) % 256]
            i = self.s2[(i + b) % 256]
            i = self.s3[(i + c) % 256]
            ...
            i = (self.S1[i] - a) % 256
            i = self.K[i]
            ciphertext += i.to_bytes(length=1, byteorder="big")
            self.ctr += 1
            self.ctr %= (1 << 32)
        return ciphertext
